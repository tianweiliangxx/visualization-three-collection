...
const draw = () => {
  if (canvasRef.value && ctx) {
    ...
    if (title) {
      ...
      let x = (width - titleWidth) / 2 - (arrowMarginTitle + 2 * arrowWidth + arrowMargin)
      const y = leftTopHeight + titleMarginTop + Number.parseInt(finalStyle.fontSize) / 2 + 2
      // 绘制标题左边箭头图案
      ...
      ctx.lineTo(x, leftTopHeight + titleMarginTop + Number.parseInt(finalStyle.fontSize))
      ctx.strokeStyle = isHover ? finalStyle.color : lineColor
      ctx.stroke()
      ctx.beginPath()
      ctx.moveTo(x + arrowWidth + arrowMargin, leftTopHeight + titleMarginTop + 4)
      ...
      ctx.lineTo(x, leftTopHeight + titleMarginTop + Number.parseInt(finalStyle.fontSize) / 2 + 2)
      ctx.lineTo(
        x + arrowWidth,
        leftTopHeight + titleMarginTop + Number.parseInt(finalStyle.fontSize),
      )
      ...
      ctx.stroke()
      ctx.beginPath()
      ctx.moveTo(x + 2 * arrowWidth + arrowMargin, leftTopHeight + titleMarginTop + 4)
      ctx.lineTo(
        x + arrowWidth + arrowMargin,
        leftTopHeight + titleMarginTop + Number.parseInt(finalStyle.fontSize) / 2 + 2,
      )
      ctx.lineTo(
